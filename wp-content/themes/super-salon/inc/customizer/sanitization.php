 ...
 */
function supersalon_sanitize_checkbox( $checked ) {
	// Boolean check.
	return ( ( isset( $checked ) && true == $checked ) ? true : false );
}


function supersalon_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
 ...
 */
function supersalon_sanitize_hex_color( $hex_color, $setting ) {
...
function supersalon_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
 ...
 */
function supersalon_sanitize_html( $html ) {
 ...
 */
function supersalon_sanitize_image( $image, $setting ) {
 ...
 */
function supersalon_sanitize_nohtml( $nohtml ) {
 ...
 */
function supersalon_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function supersalon_sanitize_range_value( $number, $setting ) {
 ...
 */
function supersalon_sanitize_select( $input, $setting ) {
 ...
 */
function supersalon_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function supersalon_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function supersalon_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
