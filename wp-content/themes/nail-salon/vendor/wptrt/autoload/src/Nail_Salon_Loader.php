...
class Nail_Salon_Loader {
	 ...
	 * @return void
	 */
	public function nail_salon_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function nail_salon_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function nail_salon_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function nail_salon_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->nail_salon_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function nail_salon_load( $class ) {
