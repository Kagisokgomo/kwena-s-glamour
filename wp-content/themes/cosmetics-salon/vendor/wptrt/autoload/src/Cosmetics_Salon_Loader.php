...
class Cosmetics_Salon_Loader {
	 ...
	 * @return void
	 */
	public function cosmetics_salon_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function cosmetics_salon_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function cosmetics_salon_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function cosmetics_salon_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->cosmetics_salon_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function cosmetics_salon_load( $class ) {
