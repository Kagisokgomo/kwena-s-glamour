...
<footer class="footer-side">
  <?php if( get_theme_mod( 'hairstylist_salon_show_footer_widget',true)) : ?>
  ...
  <?php endif; ?>
  <?php if( get_theme_mod( 'hairstylist_salon_show_footer_copyright',true)) : ?>  
    <div class="footer-copyright">
      <div class="container">
            ...
            <p class="mb-0 py-3 text-center text-md-start">
              <?php
                if (!get_theme_mod('hairstylist_salon_footer_text') ) { ?>
                  <a href="<?php echo esc_url(__('https://www.wpelemento.com/products/free-hairs-salon-wordpress-theme', 'hairstylist-salon' )); ?>" target="_blank">
        ...
        <?php if(get_theme_mod('hairstylist_salon_footer_social_icon_hide', false )== true){ ?>
          <div class="row">
            <div class="col-12 align-self-center py-1">
              <div class="footer-links">
                <?php $hairstylist_salon_settings_footer = get_theme_mod( 'hairstylist_salon_social_links_settings_footer' ); ?>
                <?php if ( is_array($hairstylist_salon_settings_footer) || is_object($hairstylist_salon_settings_footer) ){ ?>
                  <?php foreach( $hairstylist_salon_settings_footer as $hairstylist_salon_setting_footer ) { ?>
                    <a href="<?php echo esc_url( $hairstylist_salon_setting_footer['link_url'] ); ?>" target="_blank">
                      <i class="<?php echo esc_attr( $hairstylist_salon_setting_footer['link_text'] ); ?> me-2"></i>
                    </a>
                  <?php } ?>
                <?php } ?>
              </div>
  ...
  <?php endif; ?>
  <?php if(get_theme_mod('hairstylist_salon_cursor_outline', false )== true): ?>
			<!-- Custom cursor -->
