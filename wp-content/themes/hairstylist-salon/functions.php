...
if (!function_exists('hairstylist_salon_enqueue_scripts')) {
	...
	function hairstylist_salon_enqueue_scripts() {
		...
		wp_add_inline_style( 'hairstylist-salon-style',$hairstylist_salon_theme_custom_setting_css );
...
define('HAIRSTYLIST_SALON_FREE_THEME_DOC',__('https://preview.wpelemento.com/theme-documentation/hairstylist-salon/','hairstylist-salon'));
...
define('HAIRSTYLIST_SALON_BUY_NOW',__('https://www.wpelemento.com/products/salon-wordpress-theme','hairstylist-salon'));
define('HAIRSTYLIST_SALON_LIVE_DEMO',__('https://preview.wpelemento.com/hairstylist-salon/','hairstylist-salon'));
define('HAIRSTYLIST_SALON_THEME_BUNDLE',__('https://www.wpelemento.com/products/wordpress-theme-bundle','hairstylist-salon'));
