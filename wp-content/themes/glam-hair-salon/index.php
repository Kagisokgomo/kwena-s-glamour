        ...
        <div class="col-lg-8 col-md-8 col-12">
          ...
          <?php endwhile; ?>
            <?php the_posts_pagination( array(
              'prev_text' => __( 'Previous page', 'glam-hair-salon' ),
              'next_text' => __( 'Next page', 'glam-hair-salon' ),
              'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'glam-hair-salon' ) . ' </span>',
            ) ); ?>
          <?php else : ?>
