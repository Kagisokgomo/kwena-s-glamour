    ...
    <div class="notice is-dismissible mnssp">
        <div class="mnssp-notice-banner-wrap" style="background-image: url(<?php echo esc_url( MNSSP_URL . 'assets/images/banner-bg.png'); ?>)">
            <div class="mnssp-notice-heading">
              <h1 class="mnssp-main-head"><?php echo esc_html('WORDPRESS THEME BUNDLE 100+ Templates');?></h1>
              <p class="mnssp-sub-head"><?php echo esc_html('Get 100+ WordPress Themes Worth  ');?><span><?php echo esc_html('$4999+');?></span></p>
