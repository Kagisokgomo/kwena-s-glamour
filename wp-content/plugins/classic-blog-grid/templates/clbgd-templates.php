            ...
            <div class="col-md-4">
                <div class="template-banner-box">
                    ...
                    <div class="clbgd-tem-content-wrap d-flex flex-column gap-3 text-center">
                        ...
                        <p class="clbgd-tem-content-banner-para">Discover the WordPress Theme Bundle from The Classic Templates with 50+ stunning themes for any niche!</p>
                        ...
                        <div class="clbgd-tem-banner-points row">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="d-flex flex-column gap-2">
                                    <p class="gap-2 d-flex align-items-center"><img class="check-icon" src="<?php echo esc_url(CLBGD_PLUGIN_URL . 'assets/images/check.svg'); ?>" alt="<?php esc_attr_e('check', 'classic-blog-grid'); ?>"> 50+ Professionally Themes</p>
